...
export const TEXT = {
  ...
  loginSubtitle: { zh: '登录你的发起通账户，管理融资项目', en: 'Sign in to manage your financing projects' },
  registerSubtitle: { zh: '加入发起通，开始你的融资之旅', en: 'Join Originate Connect to start your financing journey' },
  emailOrUsername: { zh: '邮箱 / 用户名', en: 'Email / Username' },
  email: { zh: '邮箱', en: 'Email' },
  password: { zh: '密码', en: 'Password' },
  confirmPassword: { zh: '确认密码', en: 'Confirm Password' },
  displayName: { zh: '显示名称', en: 'Display Name' },
  company: { zh: '所属公司', en: 'Company' },
  rememberMe: { zh: '记住登录', en: 'Remember me' },
  ...
  orLoginWith: { zh: '或使用以下方式登录', en: 'Or continue with' },
  loginSuccess: { zh: '登录成功，正在跳转...', en: 'Login successful, redirecting...' },
  registerSuccess: { zh: '注册成功，正在跳转...', en: 'Registration successful, redirecting...' },
  loginFailed: { zh: '登录失败，请检查账号密码', en: 'Login failed, please check your credentials' },
  ...
  fieldRequired: { zh: '此字段为必填', en: 'This field is required' },
  ...
  logoutSuccess: { zh: '已退出登录', en: 'Signed out successfully' },
